...
<OutcomeBlock
  problem="Every 'letter from Santa' service already existed. None felt like they came from Santa. My kid didn't ask for a letter. She asked for Santa to be real."
  change="I treated a seasonal novelty like a brand people would keep: real design, a voice that never broke character, packaging worth saving. Launched in two months."
  result="HuffPost, POLITICO, KUTV, a Shopify Success Story. Three product lines, $13K+ for Toys for Tots, and a sale. Built from a bedtime question, and sold."
/>
