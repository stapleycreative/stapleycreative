---
title: "Helping people question a belief without making them defend it"
description: "Stuff You Missed in Sunday School was a social advocacy platform about religious transparency. The design problem: how do you help someone question a belief without triggering the reflex that exists to protect it?"
...
<OutcomeBlock
  problem="Evidence doesn't change minds when it threatens belonging. For believing Mormons, doctrine is family, identity, and eternity. Facts don't land as facts. They land as attacks."
  change="So I stopped arguing and started citing. Official sources only, no commentary, released slowly enough to let the contradiction sit. The goal wasn't persuasion. It was lowering the defenses it triggers."
  result="160+ cards, 4,500+ followers, a 2017 Brodie Award, a Sunstone feature, a published book. What it produced was a repeatable method for belief change without the reflexive shutdown."
/>
...
The content design was the product. Each card was a self-contained unit of cognitive dissonance. A quote from a church leader, fully sourced, presented without editorial commentary. The design of the card itself did the work. The source citation was prominent, not buried. The visual tone stayed serious and respectful. The red asterisk in the logo was the only signal that this wasn't an official church resource.
